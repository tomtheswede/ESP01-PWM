...
//Sensor details
const int devices=1; //Number of LED devices
const unsigned long devID[devices+1] = {53227777,626754355}; //Name of sensor - last one is button
const unsigned long devType[devices+1] = {37,31};
const int defaultFade = 15; //Miliseconds between fade intervals - Think about putting this in EEPROM
const int devPin[devices+1] = {2,0}; //LED pin number 12 for LED2, 13 for LED1. 2 for ESP-01
...
int ledPinState[devices] = {0}; //Default boot state of LEDs and last setPoint of the pin between 0 and 100
int ledSetPoint[devices] = {0}; //Target for dimming
int brightness[devices] = {100}; //last 'on' setpoint for 0-100 scale brightness
...
int fadeSpeed[devices] = {defaultFade}; //Time between fade intervals - 20ms between change in brightness
String data = "";
int timerCount[devices] = {0};
int timerSetpoint[devices] = {0};
